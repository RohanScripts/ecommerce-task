const cartProducts = [
  ...
  },
  {
    ...
    price: 109,
    description:
      "High-speed transfer, perfect for multitasking and high workloads",
    category: "electronics",
...
const productListing = () => {
  cartProducts.map((eachProduct) => {
    ...
    cardDiv.className =
      "md:w-[270px] sm:w-[200px] h-[322px] flex flex-col justify-between ";

    // card upper
    const cardUpper = document.createElement("div");
    cardUpper.className =
      "flex flex-col justify-between border-[2px] border-black rounded-[4px] overflow-hidden";
    // cardUpper.style.backgroundColor = "#F5F5F5"
    ...
    productImageDiv.className =
      "w-full h-[180px] flex justify-center items-center";
    ...
    addButton.className =
      "md:w-[270px] opacity-50 hover:opacity-100 duration-300 sm:w-[200px] h-[41px] bg-[#000000] flex justify-center items-center";
    ...
    addBtnText.className =
      "text-[#FFFFFF] font-[400] text-[12px] leading-[18px]";
    ...
    localItems.forEach((eachLocalItem) => {
      if (eachLocalItem.id === eachProduct.id) {
    ...
    productName.className =
      "font-[500] text-[16px] leading-[24px] text-[#000000]";
    ...
    productPrice.className =
      "text-[#DB4444] font-[500] text-[16px] leading-[24px]";
